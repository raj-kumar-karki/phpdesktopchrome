...
// form handler - must be before any HTML output
...
<button class="btn0" onclick="window.location.href='viewoffer.php'" data-key="user">रेकर्डहरू हेर्नुहोस्</button><br><br>
    <form method="POST">
      <input type="text" id="nepali-datepicker" name="record_date" placeholder="Select Nepali Date" required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

 <select name="particular" required>
...
?>
    <tr>
        ...
        <td>
           <center> <button class="btn1" onclick="window.location.href='editoffer.php?id=<?= $row['id'] ?>'" data-key="edit">मिलाउनु</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button class="btn2" onclick="window.location.href='deloffer.php?id=<?= $row['id'] ?>'" onclick="return confirm('Delete this entry?')" data-key="delete">हटाउनुहोस्</button></center>
        </td>
    </tr>
<?php endwhile; ?>
    </tbody>
