...
// Fetch Members
$result = mysqli_query($conn, "SELECT * FROM believer ORDER BY id ASC");
?>
...
<nav class="navbar">
   <a href="ubeliever.php" class="active"><i class="fas fa-user-friends"></i><span data-key="menu_believer">विश्वासी</span></a>
...
<center>
<h2 class="h2">Church Family</h2>
<table>
  <tr>
    <!-- <th>Photo</th> -->
    <th>Name</th><th>DOB</th><th>P. Address</th><th>C. Address</th><th>Contact</th><th>Baptism</th>
  </tr>
