...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE records SET record_date=?, particular=?, amount=? WHERE id=?");
...
<td><center><input type="text" id="nepali-datepicker" name="record_date" value="<?= $record['record_date'] ?>" required></center></td>
    <td><center><input type="text" name="particular" value="<?= $record['particular'] ?>" required></center></td>
