...
<nav class="navbar">
   ...
   <a href="utithe.php" class="active"><i class="fas fa-hand-holding-usd"></i><span data-key="menu_tithe">दशांश</span></a>
...
<form method="GET">
    <input type="text" name="search" placeholder="Search by date or name" value="<?= $_GET['search'] ?? '' ?>">
