...
<nav class="navbar">
   ...
   <a href="expense.php" class="active"><i class="fas fa-receipt"></i><span data-key="menu_expense">खर्च</span></a>
...
<button class="btn0" onclick="window.location.href='viewexpenses.php'" data-key="user">रेकर्डहरू हेर्नुहोस्</button><br><br>

    <form method="POST"> 

  <!-- Nepali date input (auto-filled) -->
  <input type="text" id="nepali-datepicker" name="record_date" placeholder="Select Nepali Date" required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <button  type="submit" class="btn3" data-key="pass">थप्नुहोस्</button> 
...
?>
    <tr>
        ...
        <td>
           <center> <button class="btn1" onclick="window.location.href='editexpense.php?id=<?= $row['id'] ?>'" data-key="edit">मिलाउनु</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button  class="btn2" onclick="window.location.href='delexpense.php?id=<?= $row['id'] ?>'" onclick="return confirm('Delete this entry?')" data-key="delete">हटाउनुहोस्</button></center>
        </td>
    </tr>
<?php endwhile; ?>
    </tbody>
