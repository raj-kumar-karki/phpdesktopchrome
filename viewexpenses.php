...
/* @media print {
  ...
  #print-section, #print-section * {
    visibility: visible; Show only the bill section
  }
  #print-section {
    position: absolute;
    left: 0;
...
<center>
<form method="GET">
    <input type="text" name="search" placeholder="Search by date or particular" 
           value="<?= $_GET['search'] ?? '' ?>">
      ...
      <table>
         ...
         <tbody>
            ...
            $sql = "SELECT * FROM records 
                    WHERE record_date LIKE '%$search%' 
                       OR particular LIKE '%$search%' 
